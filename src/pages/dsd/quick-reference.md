...
description: "A quick reference guide for the Dead Simple Discipline - all 8 rules at a glance."
currentPath: "/dsd/quick-reference"
---

# Dead Simple Discipline - Quick Reference

A quick reference guide for understanding and applying the Dead Simple Discipline.
...
- [Foundation](/dsd/foundation) - Understanding the zombie metaphor
- [Rules Part 1](/dsd/rules-part1) - Start Undead, Horde Ratio, 3-Click Rule
- [Rules Part 2](/dsd/rules-part2) - Three Strains, No Tunnels, Coffin Rule
- [Rules Part 3](/dsd/rules-part3) - No Unnamed Survivors, Silence the Living
- [Navigation](/dsd/navigation) - Navigation patterns and classification
- [Practice](/dsd/practice) - Real-world scenarios and violations
